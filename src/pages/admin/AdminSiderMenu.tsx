    ...
    return (
      <Sider width={240} style={{ background: '#fff' }}>
        <Menu
          ...
          theme="dark"
        >
          <Menu.Item key="inventory"><Link to={`${match.path}/inventory`}><CodeSandboxOutlined /> Inventory</Link></Menu.Item>
          <Menu.Item key="workbench"><Link to={`${match.path}/workbench`}><DatabaseOutlined /> Workbench</Link></Menu.Item>
        </Menu>
      </Sider>
    );
  }
